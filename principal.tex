...
\begin{abstract}
\noindent
O presente trabalho tem como objetivo a criação de um protótipo de comandas de casas de Happy Hour utilizando as novas tecnologias Web através da abordagem de desenvolvimento \textit{Progressive Web Apps} (PWA). O aplicativo proposto é suportado por todas as plataformas que possuem um browser com suporte as tecnologias da Web moderna, resultando em uma nova percepção para o desenvolvimento mobile. As abordagens atuais possuem vários problemas, e está nova abordagem vem com a proposta de proporcionar a mesma experiência imersiva e intuitiva das abordagens mais utilizadas no mercado, a Nativo e Híbrido Web. Através do desenvolvimento e testes foi possível elencar os pontos positivos e negativos ao se adotar essa abordagem na concepção e criação de sistemas mobile.
